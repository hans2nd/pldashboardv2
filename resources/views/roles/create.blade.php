        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Form Add Roles</h2>
                </div>
                <div class="card-body">
                        ...
                        <div class="row g-2" id="permissionsContainer">
                            @foreach ($permissions as $permission)
                                <div class="col-lg-2 col-md-3 col-sm-4 col-6 permission-item" data-name="{{ strtolower($permission->name) }}">
                                    <label class="permission-card d-block p-2 border rounded text-center cursor-pointer {{ in_array($permission->name, old('permission', [])) ? 'selected' : '' }}">
